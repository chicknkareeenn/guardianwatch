...
$male_query = "SELECT COUNT(*) as male_count FROM reports WHERE gender = 'Male' AND police_assign = $policeAssign AND EXTRACT(YEAR FROM file_date) = $selected_year";
$female_query = "SELECT COUNT(*) as female_count FROM reports WHERE gender = 'Female' AND police_assign = $policeAssign AND EXTRACT(YEAR FROM file_date) = $selected_year";
...
$brgyquery = "SELECT category, COUNT(*) AS category_count
          FROM reports
          WHERE police_assign = $policeAssign AND EXTRACT(YEAR FROM file_date) = $selected_year
          GROUP BY category
