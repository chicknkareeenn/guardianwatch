...
$sql = "SELECT 
        ...
        WHERE r.id = $1";  // PostgreSQL query syntax for prepared statements

$result = pg_query_params($conn, $sql, array($reportId)); // Use pg_query_params for parameterized query
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            if ($id2 == 1) {
                ...
                echo "<h4><a href='policereport.php'>New Report</a> / View Report No. ".$id."</h4>";
            } else if ($id2 == 3) {
                echo "<h4><a href='oncase.php'>On-Going</a> / View Report No. ".$id."</h4>";
            } else if ($id2 == 5) {
                ...
                <div class="card recent-sales overflow-auto">
                    ...
                    <div class="card-footer">
                        <div class="d-flex justify-content-end">
                            <a href="oncase.php" class="btn btn-secondary" style="background-color:#184965;">Back</a>
                        </div>
                    </div>
